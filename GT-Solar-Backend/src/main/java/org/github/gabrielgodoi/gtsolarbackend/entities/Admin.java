...
public class Admin {
    ...
    private boolean active = true; // Added field for active status

    public Admin(String id, String name, String email, String password, AdminRole adminRole, LocalDateTime created_at, LocalDateTime updated_at, boolean active) {
        this.id = id;
        this.name = name;
        this.email = email;
